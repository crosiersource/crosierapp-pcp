...
VALUES ('bfacf76d-2ff2-42c2-854c-bb5b10d78c92','crosierapp-pcp','CrosierApp para Controle de Produção','90a155bf-0d77-499c-8465-330bc4ce1dd9',now(),now(),1,1,1);
...
VALUES ('5875756c-d16d-4906-b4d0-fd60db47ba21','crosierapp-pcp - DASHBOARD', '/', 'bfacf76d-2ff2-42c2-854c-bb5b10d78c92', null, now(), now(), 1, 1, 1);
...
VALUES ('0cfdd630-4382-4a6a-beed-a0e5ec73f8df','PCP','fas fa-industry','CROSIERCORE_APPENT','5875756c-d16d-4906-b4d0-fd60db47ba21',null,0,null,now(),now(),1,1,1);

-- Entrada de menu raíz para este CrosierApp (NÃO É EXIBIDO)
INSERT INTO cfg_entmenu(uuid,label,icon,tipo,program_uuid,pai_uuid,ordem,css_style,inserted,updated,estabelecimento_id,user_inserted_id,user_updated_id)
VALUES ('90a155bf-0d77-499c-8465-330bc4ce1dd9','crosierapp-pcp (MainMenu)','','PAI','',null,0,null,now(),now(),1,1,1);
